...
const ElectionCard = ({ state, info }) => {
  ...
  return (
   ...
   <div className="rounded-3xl p-px bg-gradient-to-b from-blue-300 to-pink-300 dark:from-blue-800 dark:to-purple-800 transition-all duration-700 hover:shadow-[0_3px_10px_rgb(0.4,0.4,0.4,0.4)] dark:hover:shadow-cyan-500/50 ">
      <div className="rounded-[calc(1.5rem-1px)] p-6 w-[100%] bg-white dark:bg-gray-900">
        ...
        <div className="  flex flex-col flex-wrap items-center justify-start gap-2">
          ...
          <p className="text-gray-600 font-light text-lg md:-mt-2 lg:-mt-2 break-words text-center w-full"> {status} </p>
          ...
          {/* <p className="text-gray-400 font-light text-md md:mt-2">Poll Timings</p>   */}
            ...
            <div className="grid grid-cols-2 font-extralight items-center md:mt-2">
                ...
                <p className=" text- font-semibold text-xs whitespace-nowrap sm:text-sm whitespace-pre-line break-words text-center">
                  {date}
                </p>
            </div>
              {/* Current time ends */}
          ...
          <div className="flex flex-col sm:flex-row sm:space-x-10 space-y-10 sm:space-y-0 items-center">
            ...
            <div className="grid grid-rows-2 gap-2 font-extralight items-center">
              ...
              <p className=" text-[#F784AD] font-semibold text-xs flex flex-col sm:flex-row sm:space-x-20 space-y-4 sm:space-y-0 items-center">
                {endTime}
              </p>
            </div>
